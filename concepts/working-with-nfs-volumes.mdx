...
<CardGroup>
  <Card title="Load model files from NFS" icon="person-running-fast" href="/concepts/volumes">
    How to access model files from NFS
  </Card>
  <Card title="Load python code from NFS" icon="grid-2" href="/concepts/volumes">
    How to load python code from NFS
  </Card>
</CardGroup>
